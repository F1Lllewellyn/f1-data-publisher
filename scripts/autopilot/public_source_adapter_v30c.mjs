 ...
 * Sandbox-only scaffolding for FIA/public-source readiness crosschecks.
 * No network fetch is performed unless a later promoted adapter explicitly enables it.
 */
