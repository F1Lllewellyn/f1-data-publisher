...
Write-Host "F1 No-Code Automation Commit Ignore Fix installer"
...
$items = @(
    ...
    @{ From = "docs\F1_NO_CODE_AUTOMATION_COMMIT_IGNORE_FIX_2026-06-12.md"; To = "docs\F1_NO_CODE_AUTOMATION_COMMIT_IGNORE_FIX_2026-06-12.md" }
)
...
Write-Host "Then run: F1 Forecast Automation - Run Now Button"
