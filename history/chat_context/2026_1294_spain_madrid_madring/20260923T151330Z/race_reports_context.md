# F1 1B Race Reports Context v25
...
- Race Reports source context; Full Report only when post-race/result state supports it.
...
- race_reports: `latest/downstream_consumers/race_reports/consumer_input.json`
