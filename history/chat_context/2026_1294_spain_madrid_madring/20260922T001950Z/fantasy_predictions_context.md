# F1 1B Fantasy Predictions Context v25

## Confirmed Data
- Event: Spain - Madrid - Madring
- Session: Race / key 11369
- Run ID: 20260922T001950Z
- Consumer readiness: blocked
- Source status: needs_manual_review
- Workbook source status: needs_manual_review
- Readiness quality: blocked_manual_review_required_source
- Material change detected: False
- Notification recommended: False
- Forecast gate: off
...
- Fantasy picks, constructor/value/risk context, chip/transfer readiness proof.
- Trigger action: blocked
- Trigger reason: consumer not ready or source/workbook state is not clean/usable
...
- fantasy_predictions: `latest/downstream_consumers/fantasy_predictions/consumer_input.json`
