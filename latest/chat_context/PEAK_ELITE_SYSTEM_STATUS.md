...
Created UTC: `2026-07-12T16:32:04.404014Z`
Status: **pass**

## Confirmed Data
- Latest event: `United Kingdom - Silverstone - Silverstone`
- Latest session: `Race`
...
## System checks
- `core_files`: **pass**
- `latest_data_readiness`: **pass**
- `workbook_kpi_refresh`: **pass**
- `dashboard_readiness`: **pass**
